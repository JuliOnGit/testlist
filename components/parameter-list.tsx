    ...
    <table className='border-collapse table-auto w-full text-sm'>
      <thead>
        <tr>
          ...
          <th className='border-b dark:border-slate-600 font-medium p-4 text-slate-400 dark:text-slate-200 text-left w-4/12'>Parameter Name</th>
          ...
          <th className='border-b dark:border-slate-600 font-medium p-4 text-slate-400 dark:text-slate-200 text-left w-4/12'>Actual Value</th>
        </tr>
      </thead>
